export default {
	...
	"ExpiredCodeException": {
		"message": "the confirmation code has expired. Request a new confirmation code.",
		"statusCode": "400",
	...
	"TooManyFailedAttemptsException": {
		"message": "You have made too many failed account authorization attempts. Wait a few minutes and try again.",
		"statusCode": "400",
		"code": "TooManyFailedAttemptsException"
	},
	"TooManyRequestsException": {
		"message": "You have made too many account authorization requests. Wait a few minutes and try again.",
		"statusCode": "400",
	...
	"UserNotConfirmedException": {
		"message": "Your account email address is not confirmed.",
		"statusCode": "400",
